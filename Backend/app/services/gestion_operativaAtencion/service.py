...
from app.schemas.incidente import IncidenteHistorialOut, IncidenteOut
...
async def _notificar_y_emitir(
    ...
    for id_usuario in destinatarios:
        try:
            ...
            # El cambio ya fue confirmado. La notificacion puede reintentarse por mecanismos externos.
            pass
