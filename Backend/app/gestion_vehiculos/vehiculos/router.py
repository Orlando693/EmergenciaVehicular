...
from app.gestion_vehiculos.vehiculos.schemas import VehiculoCreate, VehiculoUpdate, VehiculoOut
from app.gestion_vehiculos.vehiculos import service as vehiculo_service
