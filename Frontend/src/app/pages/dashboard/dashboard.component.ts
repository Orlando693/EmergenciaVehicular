...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  navGroups = signal<NavGroup[]>([
    ...
    {
      section: 'GESTIÓN Y CONTROL ANALÍTICA',
      expanded: true,
      items: [
        { label: 'Dashboard Operacional', icon: 'analytics',  route: '/dashboard/dashboard-operacional', roles: ['ADMINISTRADOR', 'TALLER'] },
        { label: 'KPIs de Atención',      icon: 'kpi',       route: '/dashboard/kpis-atencion',          roles: ['ADMINISTRADOR', 'TALLER'] },
        { label: 'Análisis Incidentes',   icon: 'chart',     route: '/dashboard/incidentes-analisis',      roles: ['ADMINISTRADOR', 'TALLER'] },
        { label: 'Multi-Tenant Admin',    icon: 'tenant',    route: '/dashboard/multi-tenant-admin',       roles: ['ADMINISTRADOR'] },
      ],
    },
    {
  ...
  getIcon(name: string): string {
    const icons: Record<string, string> = {
      ...
      'analytics':  `<svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>`,
      'kpi':        `<svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>`,
      'chart':      `<svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>`,
      'tenant':     `<svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>`,
    };
    return icons[name] ?? '';
  }
}
